...
result_dir = os.path.join(path_dir, 'result_split_4dataset_nomissing', model_type, data_type)
os.makedirs(result_dir, exist_ok=True)

# === 資料讀取 ===
#test = pd.read_csv(os.path.join(path_dir, 'data', '7_sum_test', 'benign_test.csv'))
test = pd.read_csv(os.path.join(path_dir, 'data', '7_sum_test', 'benign_test_without_missing.csv'))
...
all_metrics_df.to_csv('all_metrics_summary_ctcw_split_4dataset_nomissing.csv', index=False)
print("✅ 統整與圖表已完成！")